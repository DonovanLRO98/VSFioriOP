					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5Practica",
									"targetURL": "#devsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devsapui5-display": {
								"semanticObject": "devsapui5",
								"action": "display",
								"description": "Practica de SAPUI5 en VS",
								"title": "SAPUI5Practica",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev.sapui5",
									"url": sap.ui.require.toUrl("dev/sapui5")
								}
							}
						}
					}
